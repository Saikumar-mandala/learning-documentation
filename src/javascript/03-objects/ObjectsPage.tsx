...
const ObjectsPage = () => {
    ...
    return (
        <div className="bg-gradient-to-br from-amber-500 to-orange-600 p-6 rounded-xl shadow-2xl text-white min-h-screen">
            <div className="flex justify-between items-center mb-6">
                <h3 className="text-2xl font-bold">📦 Objects Mastery</h3>
                <button
            ...
            {showConcepts && (
                <div className="mb-8 bg-white bg-opacity-95 backdrop-blur-lg rounded-xl p-8 border border-white border-opacity-20 shadow-2xl">
                    ...
                    <MarkdownViewer filePath="/docs/javascript/03-objects/ObjectsConcepts.md" />
                </div>
            )}
        </div>
    );

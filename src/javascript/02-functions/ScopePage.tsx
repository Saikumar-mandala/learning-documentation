...
const ScopePage = () => {
    ...
    return (
        <div className="bg-gradient-to-br from-slate-600 to-slate-800 p-6 rounded-xl shadow-2xl text-white min-h-screen">
            <div className="flex justify-between items-center mb-6">
                <h3 className="text-2xl font-bold">🔭 Scope & Closures</h3>
                <button
                ...
                <div className="mb-8 bg-white bg-opacity-95 backdrop-blur-lg rounded-xl p-8 border border-white border-opacity-20 shadow-2xl">
                    <div className="flex justify-between items-center mb-4">
                        <h4 className="text-2xl font-bold text-gray-800 flex items-center gap-2">
                            <i className="fa-solid fa-book-open text-slate-600"></i>
                            Scope Concepts
                        </h4>
                        <button
                    ...
                    <MarkdownViewer filePath="/docs/javascript/02-functions/ScopeConcepts.md" />
                </div>
            )}
        </div>
    );

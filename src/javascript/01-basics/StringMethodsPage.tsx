...
const StringMethodsPage = () => {
    ...
    return (
        <div className="bg-gradient-to-br from-pink-500 to-rose-600 p-6 rounded-xl shadow-2xl text-white min-h-screen">
            <div className="flex justify-between items-center mb-6">
                <h3 className="text-2xl font-bold">🔡 String Methods</h3>
                <button
            ...
            {showConcepts && (
                <div className="mb-8 bg-white bg-opacity-95 backdrop-blur-lg rounded-xl p-8 border border-white border-opacity-20 shadow-2xl">
                    ...
                    <MarkdownViewer filePath="/docs/javascript/01-basics/StringMethodsConcepts.md" />
                </div>
            )}
        </div>
    );

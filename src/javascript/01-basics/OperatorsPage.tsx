...
const OperatorsPage = () => {
    ...
    return (
        <div className="bg-gradient-to-br from-purple-500 to-violet-600 p-6 rounded-xl shadow-2xl text-white min-h-screen">
            ...
            {showConcepts && (
                <div className="mb-8 bg-white bg-opacity-95 backdrop-blur-lg rounded-xl p-8 border border-white border-opacity-20 shadow-2xl">
                    ...
                    <MarkdownViewer filePath="/docs/javascript/01-basics/OperatorsConcepts.md" />
                </div>
            )}
        </div>
    );

...
const VariablesPage = () => {
    ...
    return (
        <div className="bg-gradient-to-br from-blue-500 to-indigo-600 p-6 rounded-xl shadow-2xl text-white min-h-screen">
            <div className="flex justify-between items-center mb-6">
                <h3 className="text-2xl font-bold">📦 Variables & Data Types</h3>
                <button
            ...
            {showConcepts && (
                <div className="mb-8 bg-white bg-opacity-95 backdrop-blur-lg rounded-xl p-8 border border-white border-opacity-20 shadow-2xl">
                    ...
                    <MarkdownViewer filePath="/docs/javascript/01-basics/VariablesConcepts.md" />
                </div>
            )}
        </div>
    );
